# Getting Started with AI Team System

> **EN** | [PT](./pt/getting-started.md) | [ES](./es/getting-started.md)

---

Welcome to AI Team System. This guide is optimized for first-value in 10 minutes.
...
_AI Team System Getting Started Guide v4.2.11_
