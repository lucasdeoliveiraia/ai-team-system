...
本指南提供了从您的系统中卸载 AI Team System 的全面说明。
...
```bash
#!/bin/bash
echo "AI Team System 完全卸载"
echo "================================="

# 确认
read -p "这将删除所有 AI Team System 数据。继续吗？(y/N) " -n 1 -r
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
    exit 1
fi
