...
**AI Team System** (AI Operating System) 是一个框架，它改变了团队构建软件的方式 — 将 **专业化 AI 代理** 与 **真实人类** 结合在一种独特的敏捷方法论中。
...
flowchart LR
    ...
    subgraph AIOX_WAY["AI Team System (Task-First)"]
        direction TB
