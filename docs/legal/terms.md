...
By using AI Team System ("the Software"), you agree to be bound by these Terms of Use. If you do not agree to these terms, do not use the Software.

## License

AI Team System is released under the **MIT License**. See the [LICENSE](LICENSE) file for the full license text.
...
By contributing to AI Team System, you agree that:
...
AI Team System includes third-party open-source components. Each component is subject to its own license terms:
...
When using AI providers (Claude, OpenAI, etc.) through AI Team System:
...
These Terms of Use, together with the [LICENSE](LICENSE), [Privacy Policy](PRIVACY.md), and [Code of Conduct](CODE_OF_CONDUCT.md), constitute the entire agreement between you and SynkraAI Inc. regarding use of AI Team System.
