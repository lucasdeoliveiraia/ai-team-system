...
# Começando com o AI Team System

> 🌐 [EN](../getting-started.md) | **PT** | [ES](../es/getting-started.md)

---

Bem-vindo ao AI Team System! Este guia irá orientá-lo nos seus primeiros passos com o framework de desenvolvimento auto-modificável alimentado por IA.
...
Antes de instalar o AI Team System, certifique-se de ter:
...
O AI Team System oferece opções flexíveis de instalação:
...
O meta-agent é o núcleo do AI Team System - uma IA que entende e pode modificar sua própria base de código.
...
Lembre-se: O AI Team System aprende e melhora com o uso. Quanto mais você interagir com ele, melhor ele entenderá seu estilo e necessidades de desenvolvimento.

Bom código com o AI Team System!
