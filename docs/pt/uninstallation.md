...
Este guia fornece instruções completas para desinstalar o AI Team System do seu sistema.
...
**Aviso**: Desinstalar o AI Team System irá:
...
A forma mais rápida de desinstalar o AI Team System:
...
Remove-Item -Path "HKCU:\Software\AI Team System" -Recurse
```
...
```bash
#!/bin/bash
echo "Desinstalação Completa do AI Team System"
echo "================================="

# Confirmação
read -p "Isso removerá TODOS os dados do AI Team System. Continuar? (y/N) " -n 1 -r
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
    exit 1
fi
...
Write-Host "Limpando AI Team System do Registro do Windows..."
...
#!/bin/bash
# force-uninstall.sh
echo "Desinstalação forçada do AI Team System..."
...
# Commitar remoção
git add -A
git commit -m "Remove AI Team System"
```
...
Se você quiser reinstalar o AI Team System:
