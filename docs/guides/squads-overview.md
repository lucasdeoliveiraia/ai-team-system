...
Introduction to AI Team Systems - modular teams of AI agents that extend framework functionality.
...
> **AI Team Systems:** AI agent teams working with you
...
| Traditional Agents   | AI Team Systems                |
| -------------------- | -------------------------- |
...
_AI Team Systems: AI agent teams working with you_
