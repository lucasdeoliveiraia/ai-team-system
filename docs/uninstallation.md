...
This guide provides comprehensive instructions for uninstalling AI Team System from your system.
...
⚠️ **Warning**: Uninstalling AI Team System will:
...
The fastest way to uninstall AI Team System:
...
```bash
#!/bin/bash
echo "AI Team System Complete Uninstall"
echo "================================="

# Confirmation
read -p "This will remove ALL AI Team System data. Continue? (y/N) " -n 1 -r
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
    exit 1
fi
...
Write-Host "Cleaning AI Team System from Windows Registry..."
...
#!/bin/bash
# force-uninstall.sh
echo "Force uninstalling AI Team System..."
...
If you want to reinstall AI Team System:
