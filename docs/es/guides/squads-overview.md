...
Introduccion a AI Team Systems - equipos modulares de agentes IA que extienden la funcionalidad del framework.
...
> **AI Team Systems:** Equipos de agentes IA trabajando contigo
...
| Agentes Tradicionales      | AI Team Systems                    |
| -------------------------- | ------------------------------ |
...
_AI Team Systems: Equipos de agentes IA trabajando contigo_
