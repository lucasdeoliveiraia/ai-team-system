...
This directory contains tool integration definitions for AI Team System agents. Tools are external capabilities that agents can discover and use to accomplish tasks.
