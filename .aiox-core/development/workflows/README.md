...
This directory contains workflow definitions for the AI Team System framework. Workflows define multi-step processes that can be executed by AIOX agents.
