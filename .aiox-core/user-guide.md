# Guia do Usuário AI Team System

## Visão Geral

O AI Team System é um framework de desenvolvimento full stack orientado por agentes de IA que implementa uma metodologia ágil única. Este guia explica como usar o AI Team System de forma eficaz através de suas duas fases principais: **Planejamento** e **Desenvolvimento**.
...
O AI Team System usa uma abordagem de duas fases que separa planejamento estratégico de implementação tática:
...
O agente **qa** do AI Team System inclui capacidades avançadas de arquitetura de testes:
...
O AI Team System permite configurar preferências técnicas que influenciam decisões dos agentes:
...
Ao integrar AI Team System em projetos existentes:
...
O AI Team System inclui meta-agentes para orquestração:
...
O AI Team System suporta squads para domínios específicos:
...
*AI Team System User Guide v2.0*
